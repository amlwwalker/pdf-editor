...
Item {
    ...
    height: img.sourceSize.height * imgScale
        ...
        FileDialog {
            ...
            onAccepted: {
                ...
                var urlNoProtocol = (fileDialog.fileUrl+"").replace('file://', '');
    ...
    ScrollView {
        ...
        Flickable {
            ...
            {
                id: img
                source: "file:///Users/alex/go/src/github.com/amlwwalker/engineering-drawing-to-image/ML-MT-PH-00005.000_REV1A/edit/ML-MT-PH-00005.000_REV1A.edited.000.png"
            }
            Canvas {
                id: myCanvas
